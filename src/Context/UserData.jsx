...
import { getAuth, createUserWithEmailAndPassword, updateProfile, signInWithEmailAndPassword, signOut, onAuthStateChanged, sendPasswordResetEmail } from "firebase/auth";
...
function UserData({ children }) {
  ...
  async function RestUserPswd(email) {
  ...
  const store = { userDetails, setUserDetails, signIn, signUp, logOut, uploadProfileImg, RestUserPswd }
